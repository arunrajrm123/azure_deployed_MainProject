...
class TrainerSignup(APIView):
    def post(self,request):
        ...
        catogery=request.data.get("catogery")
        ...
        print(certificate)
        print(c)
        trainerobj= Trainers.objects.create(name=name,email=email,password=password,phone=phonenumber,certificate=certificate,course=cour,course_fee=fee)
